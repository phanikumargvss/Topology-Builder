...
print "\nEnter filename suffix (all text after 'topology-' up to '.'."
file_append = raw_input("\nFilename suffix: ")
upper_limit = raw_input("\nEnter upper limit: ")
lower_limit = raw_input("Enter lower limit: ")
...
g1 = pydot.Dot(graph_type='graph', splines=info.graph_type(),
               ranksep="8.5", nodesep="0.01")
