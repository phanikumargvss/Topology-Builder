...
g1 = pydot.Dot(graph_type='graph', splines=graph_type,
               ranksep="6.0", nodesep="0.3")
...
print "\nTopology re-generated at:" % file_append
